    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                <div class="custom-block-image-wrap">
                    <a href="event-detail.php">
                        <img src="includes/assets/images/anna-rosar-ew-olGvgCCs-unsplash.jpg" class="custom-block-image img-fluid" alt="">
            ...
            <div class="col-lg-6 col-12">
                <div class="custom-block-image-wrap">
                    <a href="event-detail.php">
                        <img src="includes/assets/images/frederik-rosar-NDSZcCfnsbY-unsplash.jpg" class="custom-block-image img-fluid" alt="">
